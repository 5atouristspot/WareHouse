...
class MosefsChunkExample(unittest.TestCase):
    def test_moosefs_logger_port_fail(self):
        fail_request = requests.get(url='http://192.168.1.116:3621/api/v1000/moosefs/chunk',
                                    auth=('da', 'xinxin'),
                                    params={'host': '192.168.71.143', 'port': 20, 'muser': 'root', 'mpassword': 'tfkj706tfkj706'})
    ...
    def test_moosefs_logger_ok(self):
        ok_request = requests.get(url='http://192.168.1.116:3621/api/v1000/moosefs/chunk',
                                  auth=('da', 'xinxin'),
                                  params={'host': '192.168.71.143', 'port': 22, 'muser': 'root', 'mpassword': 'tfkj706tfkj706'})
