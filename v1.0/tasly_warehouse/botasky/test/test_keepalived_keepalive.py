...
class KeepaliveExample(unittest.TestCase):
    def test_keepalived_keepalive_port_fail(self):
        fail_request = requests.get(url='http://192.168.1.116:3621/api/v1000/keepalived/keepalive',
                                    auth=('da', 'xinxin'),
    ...
    def test_keepalived_keepalive_host_fail(self):
        fail_request = requests.get(url='http://192.168.1.116:3621/api/v1000/keepalived/keepalive',
                                    auth=('da', 'xinxin'),
    ...
    def test_keepalived_keepalive_ok(self):
        ok_request = requests.get(url='http://192.168.1.116:3621/api/v1000/keepalived/keepalive',
                                  auth=('da', 'xinxin'),
